...
<div className="stack-items">
  <section className="primary-sections">
    ...
    <section id="bottom-cta" class="bottom-cta container">
        <article class="quote">
          <blockquote>
            {ctaLayer.quote}
            <cite>
        ...
        <article class="cta">
          ...
          <h2><span class="accent">{ctaLayer.title}</span>{ctaLayer.subtitle}</h2>
          <a href={ctaLayer.buttonHref} class="btn-primary">{ctaLayer.buttonTitle}</a>
        </article>
    </section>
</div>
        );
